...
public class HbaseTableModel extends DefaultTableModel {
    ...
    private static String[][] data = new String[][]{
            {"cf1: 12345688", "123456789", "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc"},
            {"cf1: 12345688", "123456789", "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc"}
    };

    // 表格字段
    private static String[] columnNames = CONSTANT.ROW_TABLE_COLUMNS;
